...
const reportIncludes = [
  ...
  },
  {
    ...
    desc: "How does this brand compare to the top 3–5 competitors in its category? Investment range, royalty burden, unit economics, and growth trajectory — side by side, sourced from government-filed FDD data.",
